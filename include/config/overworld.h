...
#define OW_SECRET_POWER_FIELD_MOVE      TRUE      // If enabled, Secret Power can be used as a Field Move as seen in RSE.
#define OW_DIVE_FIELD_MOVE              TRUE      // If enabled, Dive can be used as a Field Move as seen in RSE.
