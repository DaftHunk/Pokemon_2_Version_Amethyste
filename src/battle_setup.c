...
enum BattleEnvironments BattleSetup_GetEnvironmentId(void)
{
    ...
    {
        if (IS_MAP(MAP_BLACKTHORN_CITY, MAP_BLACKTHORN_CITY)
        || IS_MAP(MAP_CIANWOOD_CITY, MAP_CIANWOOD_CITY)
        || IS_MAP(MAP_DRAGONS_DEN_CAVERN, MAP_DRAGONS_DEN_CAVERN)
        || IS_MAP(MAP_LAKE_OF_RAGE, MAP_LAKE_OF_RAGE)
        || IS_MAP(MAP_LAKE_OF_RAGE_LOW_TIDE, MAP_LAKE_OF_RAGE_LOW_TIDE)
        || IS_MAP(MAP_MAHOGANYTOWN, MAP_MAHOGANYTOWN)
        || IS_MAP(MAP_MT_MORTAR_2F, MAP_MT_MORTAR_2F)
        || IS_MAP(MAP_MT_MORTAR_B1F, MAP_MT_MORTAR_B1F)
        || IS_MAP(MAP_MT_SILVER_OUTSIDE, MAP_MT_SILVER_OUTSIDE)
        || IS_MAP(MAP_MT_SILVER_MOUNTAIN_SIDE, MAP_MT_SILVER_MOUNTAIN_SIDE)
        || IS_MAP(MAP_MT_SILVER_2F, MAP_MT_SILVER_2F)
        || IS_MAP(MAP_MT_SILVER_SNOW, MAP_MT_SILVER_SNOW)
        || IS_MAP(MAP_MT_SILVER_3F, MAP_MT_SILVER_3F)
        || IS_MAP(MAP_ROUTE28, MAP_ROUTE28)
        || IS_MAP(MAP_ROUTE41, MAP_ROUTE41)
        || IS_MAP(MAP_ROUTE42, MAP_ROUTE42)
        || IS_MAP(MAP_ROUTE43, MAP_ROUTE43)
        || IS_MAP(MAP_ROUTE44, MAP_ROUTE44)
        || IS_MAP(MAP_ROUTE45, MAP_ROUTE45)
        || IS_MAP(MAP_ROUTE46, MAP_ROUTE46)
        || IS_MAP(MAP_ROUTE47, MAP_ROUTE47)
        || IS_MAP(MAP_ROUTE48, MAP_ROUTE48)
        || IS_MAP(MAP_RUINS_OF_ALPH_OUTSIDE, MAP_RUINS_OF_ALPH_OUTSIDE)
        || IS_MAP(MAP_SAFARI_ZONE1, MAP_SAFARI_ZONE1)
        || IS_MAP(MAP_SAFARI_ZONE2, MAP_SAFARI_ZONE2)
        || IS_MAP(MAP_SAFARI_ZONE3, MAP_SAFARI_ZONE3)
        || IS_MAP(MAP_SAFARI_ZONE_ENTERANCE, MAP_SAFARI_ZONE_ENTERANCE)
        || IS_MAP(MAP_SAFARI_ZONE_GATE, MAP_SAFARI_ZONE_GATE)
        || IS_MAP(MAP_SAFARI_ZONE_LOW_LEFT, MAP_SAFARI_ZONE_LOW_LEFT)
        || IS_MAP(MAP_SAFARI_ZONE_LOW_MID, MAP_SAFARI_ZONE_LOW_MID)
        || IS_MAP(MAP_SAFARI_ZONE_LOW_RIGHT, MAP_SAFARI_ZONE_LOW_RIGHT)
        || IS_MAP(MAP_SAFARI_ZONE_TOP_LEFT, MAP_SAFARI_ZONE_TOP_LEFT)
        || IS_MAP(MAP_SAFARI_ZONE_TOP_MID, MAP_SAFARI_ZONE_TOP_MID)
        || IS_MAP(MAP_SAFARI_ZONE_TOP_RIGHT, MAP_SAFARI_ZONE_TOP_RIGHT)
        || IS_MAP(MAP_WHIRL_ISLANDS_1F, MAP_WHIRL_ISLANDS_1F)
        || IS_MAP(MAP_MT_SILVER_SNOW, MAP_MT_SILVER_SNOW)
        || IS_MAP(MAP_ROUTE3, MAP_ROUTE3)
        || IS_MAP(MAP_ROUTE4, MAP_ROUTE4)
        || IS_MAP(MAP_ROUTE9, MAP_ROUTE9)
        || IS_MAP(MAP_ROUTE10, MAP_ROUTE10))
        {
            return BATTLE_ENVIRONMENT_MOUNTAIN;
        }

        if (IS_MAP(MAP_FUCHSIA_CITY_SAFARI_ZONE_BEACH, MAP_FUCHSIA_CITY_SAFARI_ZONE_BEACH) 
        || IS_MAP(MAP_CINNABAR_ISLAND, MAP_CINNABAR_ISLAND))
        {
    ...
    {
        if (IS_MAP(MAP_FUCHSIA_CITY_SAFARI_ZONE_MOUNTAIN, MAP_FUCHSIA_CITY_SAFARI_ZONE_MOUNTAIN))
        {
            return BATTLE_ENVIRONMENT_MOUNTAIN;
        }
    ...
    switch (gMapHeader.mapType)
    {
        ...
        case MAP_TYPE_UNDERGROUND:
            ...
            if (IS_MAP(MAP_CERULEAN_CAVE_1F, MAP_CERULEAN_CAVE_1F)
            || IS_MAP(MAP_CERULEAN_CAVE_B1F, MAP_CERULEAN_CAVE_B1F)
            || IS_MAP(MAP_CERULEAN_CAVE_B2F, MAP_CERULEAN_CAVE_B2F)
            || IS_MAP(MAP_WHIRL_ISLANDS_1F, MAP_WHIRL_ISLANDS_1F)
            || IS_MAP(MAP_WHIRL_ISLANDS_B1F, MAP_WHIRL_ISLANDS_B1F)
            || IS_MAP(MAP_WHIRL_ISLANDS_B2F, MAP_WHIRL_ISLANDS_B2F)
            || IS_MAP(MAP_SEAFOAM_ISLANDS_1F, MAP_SEAFOAM_ISLANDS_1F)
            || IS_MAP(MAP_SEAFOAM_ISLANDS_GYM, MAP_SEAFOAM_ISLANDS_GYM)
            || IS_MAP(MAP_SEAFOAM_ISLANDS_B1F, MAP_SEAFOAM_ISLANDS_B1F)
            || IS_MAP(MAP_MT_SILVER_1F_ITEM_ROOM, MAP_MT_SILVER_1F_ITEM_ROOM)
            || IS_MAP(MAP_MT_SILVER_1F_WATERFALL_ROOM, MAP_MT_SILVER_1F_WATERFALL_ROOM)
            || IS_MAP(MAP_MT_SILVER_1F_MOLTRES_ROOM, MAP_MT_SILVER_1F_MOLTRES_ROOM)
            || IS_MAP(MAP_MT_SILVER_2F, MAP_MT_SILVER_2F)
            || IS_MAP(MAP_MT_SILVER_3F, MAP_MT_SILVER_3F)
            || IS_MAP(MAP_ICE_PATH_1F, MAP_ICE_PATH_1F)
            || IS_MAP(MAP_ICE_PATH_B1F, MAP_ICE_PATH_B1F)
            || IS_MAP(MAP_ICE_PATH_B2F, MAP_ICE_PATH_B2F)
            || IS_MAP(MAP_ICE_PATH_B3F, MAP_ICE_PATH_B3F)
            || IS_MAP(MAP_ICE_PATH_B4F, MAP_ICE_PATH_B4F)
            || IS_MAP(MAP_MT_MORTAR_1F_SOUTH, MAP_MT_MORTAR_1F_SOUTH)
            || IS_MAP(MAP_MT_MORTAR_1F_NORTH, MAP_MT_MORTAR_1F_NORTH)
            || IS_MAP(MAP_MT_MORTAR_2F, MAP_MT_MORTAR_2F)
            || IS_MAP(MAP_MT_MORTAR_B1F, MAP_MT_MORTAR_B1F)
            || IS_MAP(MAP_DRAGONS_DEN_ENTRANCE, MAP_DRAGONS_DEN_ENTRANCE)
            || IS_MAP(MAP_DRAGONS_DEN_CAVERN, MAP_DRAGONS_DEN_CAVERN)
            || IS_MAP(MAP_ROCK_TUNNEL_B1F, MAP_ROCK_TUNNEL_B1F)
            || IS_MAP(MAP_ROCK_TUNNEL_1F, MAP_ROCK_TUNNEL_1F)
            || IS_MAP(MAP_SLOWPOKE_WELL_B1F, MAP_SLOWPOKE_WELL_B1F)
            || IS_MAP(MAP_SLOWPOKE_WELL_B2F, MAP_SLOWPOKE_WELL_B2F)
            || IS_MAP(MAP_SAFARI_ZONE_LOW_RIGHT, MAP_SAFARI_ZONE_LOW_RIGHT)
            || IS_MAP(MAP_FUCHSIA_CITY_SAFARI_ZONE_CAVE, MAP_FUCHSIA_CITY_SAFARI_ZONE_CAVE)
            || IS_MAP(MAP_RUINS_OF_ALPH_B1F, MAP_RUINS_OF_ALPH_B1F))
            {
        ...
        case MAP_TYPE_INDOOR:
            if (IS_MAP(MAP_ROCKET_HIDEOUT_B1F, MAP_ROCKET_HIDEOUT_B1F)
            || IS_MAP(MAP_ROCKET_HIDEOUT_B2F, MAP_ROCKET_HIDEOUT_B2F)
            || IS_MAP(MAP_ROCKET_HIDEOUT_B3F, MAP_ROCKET_HIDEOUT_B3F)
            || IS_MAP(MAP_GOLDENROD_CITY_UNDERGROUND_ENTRANCE, MAP_GOLDENROD_CITY_UNDERGROUND_ENTRANCE)
            || IS_MAP(MAP_GOLDENROD_CITY_UNDERGROUND_SWITCHES, MAP_GOLDENROD_CITY_UNDERGROUND_SWITCHES)
            || IS_MAP(MAP_GOLDENROD_CITY_UNDERGROUND_TUNNEL, MAP_GOLDENROD_CITY_UNDERGROUND_TUNNEL)
            || IS_MAP(MAP_GOLDENROD_CITY_UNDERGROUND_STORAGE, MAP_GOLDENROD_CITY_UNDERGROUND_STORAGE)
            ...
            || IS_MAP(MAP_VIOLET_CITY_GYM, MAP_VIOLET_CITY_GYM)
            || IS_MAP(MAP_ECRUTEAK_CITY_GYM, MAP_ECRUTEAK_CITY_GYM)
            || IS_MAP(MAP_CIANWOOD_GYM, MAP_CIANWOOD_GYM)
            || IS_MAP(MAP_OLIVINE_CITY_LIGHTHOUSE, MAP_OLIVINE_CITY_LIGHTHOUSE)
            || IS_MAP(MAP_OLIVINE_CITY_GYM, MAP_OLIVINE_CITY_GYM)
            || IS_MAP(MAP_MAHOGANY_TOWN_GYM, MAP_MAHOGANY_TOWN_GYM)
            || IS_MAP(MAP_BLACKTHORN_CITY_GYM, MAP_BLACKTHORN_CITY_GYM)
            || IS_MAP(MAP_VIRIDIAN_CITY_GYM, MAP_VIRIDIAN_CITY_GYM)
            || IS_MAP(MAP_CERULEAN_CITY_GYM, MAP_CERULEAN_CITY_GYM)
            || IS_MAP(MAP_SAFFRON_CITY_GYM, MAP_SAFFRON_CITY_GYM))
            {
                return BATTLE_ENVIRONMENT_BLUE_BUILDING;
            }
            return BATTLE_ENVIRONMENT_BUILDING;
...
#if !IS_HNS
    // TODO: Define MAP_ROUTE113 (and all Emeramd maps)
    //if (IS_MAP(MAP_ROUTE113, MAP_ROUTE113))
    //    return BATTLE_ENVIRONMENT_SAND;
#endif // !IS_HNS
