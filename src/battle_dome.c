...
static const u8 *const sBattleDomePotentialTexts[DOME_TOURNAMENT_TRAINERS_COUNT + 1] =
{
    ...
    COMPOUND_STRING("Équipe à très fort potentiel."),
    COMPOUND_STRING("Équipe dont on ne sait rien."),
    COMPOUND_STRING("Équipe au-dessus de la moyenne."),
    COMPOUND_STRING("Équipe dans la moyenne."),
    COMPOUND_STRING("Équipe à potentiel moyen."),
    COMPOUND_STRING("Équipe en dessous de la moyenne."),
    COMPOUND_STRING("Équipe n’ayant encore jamais gagné."),
    COMPOUND_STRING("Une victoire les rendrait très fiers."),
    COMPOUND_STRING("Équipe assez faible dans l’ensemble."),
    COMPOUND_STRING("Équipe à potentiel très faible."),
    COMPOUND_STRING("Équipe qui n’ira sûrement pas en finale."),
    COMPOUND_STRING("Équipe au potentiel le plus faible."), // Lowest potential
...
static const u8 *const sBattleDomeOpponentStyleTexts[NUM_BATTLE_STYLES] =
{
    ...
    [DOME_BATTLE_STYLE_BALANCED]        = COMPOUND_STRING("Éventail de capacités bien équilibré."),
...
static const u8 *const sBattleDomeOpponentStatsTexts[] =
{
    ...
    COMPOUND_STRING("Favorise les PV et la Défense."),
    COMPOUND_STRING("Favorise les PV et la Vitesse."),
    COMPOUND_STRING("Favorise les PV et l’Atq. Spé."),
    COMPOUND_STRING("Favorise les PV et la Déf. Spé."),
    COMPOUND_STRING("Favorise l’Attaque et la Défense."),         // DOME_TEXT_ATK starts here
    COMPOUND_STRING("Favorise l’Attaque et la Vitesse."),
    COMPOUND_STRING("Favorise l’Attaque et l’Atq. Spé."),
    COMPOUND_STRING("Favorise l’Attaque et la Déf. Spé."),
    COMPOUND_STRING("Favorise la Défense et la Vitesse."),          // DOME_TEXT_DEF starts here
    COMPOUND_STRING("Favorise la Défense et l’Atq. Spé."),
    COMPOUND_STRING("Favorise la Défense et la Déf. Spé."),
    COMPOUND_STRING("Favorise la Vitesse et l’Atq. Spé."),       // DOME_TEXT_SPEED starts here
    COMPOUND_STRING("Favorise la Vitesse et la Déf. Spé."),
    COMPOUND_STRING("Favorise l’Atq. Spé. et la Déf. Spé."), // DOME_TEXT_SPATK starts here
    COMPOUND_STRING("Favorise les PV."),                         // DOME_TEXT_ONE_GOOD_STAT starts here
    COMPOUND_STRING("Favorise l’Attaque."),
    COMPOUND_STRING("Favorise la Défense."),
    COMPOUND_STRING("Favorise la Vitesse."),
    COMPOUND_STRING("Favorise l’Atq. Spé."),
    COMPOUND_STRING("Favorise la Déf. Spé."),
    COMPOUND_STRING("Néglige les PV et l’Attaque."),                // DOME_TEXT_TWO_BAD_STATS starts here
    COMPOUND_STRING("Néglige les PV et la Défense."),
    COMPOUND_STRING("Néglige les PV et la Vitesse."),
    COMPOUND_STRING("Néglige les PV et l’Atq. Spé."),
    COMPOUND_STRING("Néglige les PV et la Déf. Spé."),
    COMPOUND_STRING("Néglige l’Attaque et la Défense."),
    COMPOUND_STRING("Néglige l’Attaque et la Vitesse."),
    COMPOUND_STRING("Néglige l’Attaque et l’Atq. Spé."),
    COMPOUND_STRING("Néglige l’Attaque et la Déf. Spé."),
    COMPOUND_STRING("Néglige la Défense et la Vitesse."),
    COMPOUND_STRING("Néglige la Défense et l’Atq. Spé."),
    COMPOUND_STRING("Néglige la Défense et la Déf. Spé."),
    COMPOUND_STRING("Néglige la Vitesse et l’Atq. Spé."),
    COMPOUND_STRING("Néglige la Vitesse et la Déf. Spé."),
    COMPOUND_STRING("Néglige l’Atq. Spé. et la Déf. Spé."),
    COMPOUND_STRING("Néglige les PV."),                           // DOME_TEXT_ONE_BAD_STAT starts here
    COMPOUND_STRING("Néglige l’Attaque."),
    COMPOUND_STRING("Néglige la Défense."),
    COMPOUND_STRING("Néglige la Vitesse."),
    COMPOUND_STRING("Néglige l’Atq. Spé."),
    COMPOUND_STRING("Néglige la Déf. Spé."),
    [DOME_TEXT_WELL_BALANCED] = COMPOUND_STRING("Élève ses Pokémon de façon équilibrée."),
};
