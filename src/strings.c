...
const u8 gText_BillsPC[] = _("PC de Léo");
...
const u8 gText_MenuOptionPokenav[] = _("Pokématos");
...
const u8 gText_MenuPokenav[] = _("Pokématos");
...
const u8 gText_BaobaMatchCallName[] = _("M. Souryre");
