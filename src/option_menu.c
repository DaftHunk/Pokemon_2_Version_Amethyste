...
static const u8 *const sChoices_TextSpeed[] = {
    COMPOUND_STRING("Lent"),
    COMPOUND_STRING("Moyen"),
    COMPOUND_STRING("Vite"),
    COMPOUND_STRING("Turbo"),
};
...
static const u8 *const sChoices_Gen3Gen4[] = {
    COMPOUND_STRING("Gén. 3"),
    COMPOUND_STRING("Gén. 4"),
};
...
static const u8 sText_Desc_TextSpeed[] = _("Choisis l’une des quatre vitesses\nd’affichage du texte.");
...
static const u8 *const sDesc_BattleScene[] = {
    COMPOUND_STRING("Affiche les animations des Pokémon\net des attaques."),
    COMPOUND_STRING("Passe les animations des Pokémon\net des attaques."),
};
static const u8 *const sDesc_BattleStyle[] = {
    COMPOUND_STRING("Permet de changer de Pokémon quand\ncelui de l’adversaire est K.O."),
    COMPOUND_STRING("Aucun changement offert après un\nPokémon adverse mis K.O."),
};
static const u8 *const sDesc_ButtonMode[] = {
    ...
    COMPOUND_STRING("Le bouton L sert de second bouton A,\npour jouer d’une seule main."),
};
static const u8 *const sDesc_Follower[] = {
    COMPOUND_STRING("Le premier Pokémon de ton équipe\nte suit."),
    COMPOUND_STRING("Tu marches seul."),
};
static const u8 *const sDesc_LargeFollower[] = {
    COMPOUND_STRING("Autorise les grands Pokémon suiveurs.\nPeut causer des soucis graphiques."),
    COMPOUND_STRING("Désactive les grands Pokémon\nsuiveurs. Recommandé."),
};
static const u8 *const sDesc_Autorun[] = {
    COMPOUND_STRING("Cours sans appuyer sur B."),
    COMPOUND_STRING("Maintiens B pour courir."),
};
static const u8 *const sDesc_AutorunSurf[] = {
    COMPOUND_STRING("Surfe plus vite sans appuyer sur B."),
    COMPOUND_STRING("Maintiens B pour surfer plus vite."),
};
static const u8 *const sDesc_Fishing[] = {
    COMPOUND_STRING("Ferre automatiquement à la pêche."),
    COMPOUND_STRING("Ferrage manuel à la pêche.\nPêche comme tu l’as toujours fait !"),
};
static const u8 *const sDesc_FasterJoy[] = {
    COMPOUND_STRING("L’Infirmière Joëlle soigne plus vite."),
    COMPOUND_STRING("L’Infirmière Joëlle soigne avec\nl’animation habituelle."),
};
static const u8 *const sDesc_UnitType[] = {
    COMPOUND_STRING("Affiche poids et taille des Baies et\ndes Pokémon en kilos et en mètres."),
    COMPOUND_STRING("Affiche poids et taille des Baies et\ndes Pokémon en livres et en pouces."),
};
static const u8 *const sDesc_MatchCall[] = {
    COMPOUND_STRING("Les Dresseurs peuvent t’appeler pour\nun match retour ou des infos."),
    COMPOUND_STRING("Tu ne recevras aucun appel.\nLes évènements spéciaux ont lieu."),
};
static const u8 *const sDesc_FrameType[] = {
    COMPOUND_STRING("Choisis le cadre qui entoure les\nfenêtres."),
};
static const u8 *const sDesc_FastIntro[] = {
    COMPOUND_STRING("Passe l’animation d’entrée et\ndémarre les combats plus vite."),
    COMPOUND_STRING("Les combats démarrent à la vitesse\nhabituelle."),
};
static const u8 *const sDesc_FastBattles[] = {
    COMPOUND_STRING("Supprime toutes les pauses en combat,\nce qui les rend plus rapides."),
    COMPOUND_STRING("Pauses manuelles : appuie sur A ou B\npour les passer."),
};
...
static const u8 *const sDesc_NewBattleUI[] = {
    COMPOUND_STRING("Interface de combat Gén. III\nd’origine."),
    COMPOUND_STRING("Interface de combat Gén. IV\nmodernisée."),
};
static const u8 *const sDesc_BallPrompt[] = {
    COMPOUND_STRING("Appuie sur {R_BUTTON} en combat pour les Balls.\nMaintiens {L_BUTTON}/{R_BUTTON} pour en changer."),
    COMPOUND_STRING("Désactive l’accès rapide aux\nPoké Balls."),
};
static const u8 *const sDesc_RunType[] = {
    COMPOUND_STRING("Pas de fuite rapide en combat."),
    COMPOUND_STRING("Maintiens {L_BUTTON}+{R_BUTTON} puis {A_BUTTON} pour fuir avant\nle début du combat."),
    COMPOUND_STRING("Appuie sur {B_BUTTON} pour placer le curseur\nsur Fuite une fois le combat lancé."),
    COMPOUND_STRING("Appuie sur {B_BUTTON} pour fuir avant le début\ndu combat."),
};
static const u8 *const sDesc_LRRun[] = {
    COMPOUND_STRING("Affiche un rappel indiquant que tu\npeux fuir le combat."),
    COMPOUND_STRING("Masque ce rappel. La combinaison de\nboutons fonctionne toujours."),
};
static const u8 *const sDesc_Sound[] = {
    COMPOUND_STRING("Même son sur tous les haut-parleurs.\nRecommandé sur console d’origine."),
    COMPOUND_STRING("Sépare les canaux gauche et droit.\nIdéal au casque."),
};
static const u8 *const sDesc_Music[] = {
    COMPOUND_STRING("Active la musique. Change de zone\npour appliquer."),
    COMPOUND_STRING("Coupe la musique. Change de zone\npour appliquer."),
};
static const u8 *const sDesc_BikeMusic[] = {
    COMPOUND_STRING("Active la musique du Vélo."),
    COMPOUND_STRING("Coupe la musique du Vélo."),
};
static const u8 *const sDesc_SurfMusic[] = {
    COMPOUND_STRING("Active la musique de Surf."),
    COMPOUND_STRING("Coupe la musique de Surf."),
};
...
static const struct OptionMenuItem sTabItems_Main[] = {
    [ITEM_MAIN_TEXTSPEED] = {
        .name         = COMPOUND_STRING("Vit. Texte"),
        .descriptions = sDesc_TextSpeed,
        .numChoices   = 4,
        .choiceNames  = sChoices_TextSpeed,
    },
    [ITEM_MAIN_BATTLESCENE] = {
        .name         = COMPOUND_STRING("Anima. Combat"),
    ...
    [ITEM_MAIN_AUTORUN_SURF] = {
        .name         = COMPOUND_STRING("Surf Auto"),
...
static const struct OptionMenuItem sTabItems_Battle[] = {
    ...
    [ITEM_BATTLE_NEW_BACKGROUNDS] = {
        .name         = COMPOUND_STRING("Décor Combat"),
    ...
    [ITEM_BATTLE_BALL_PROMPT] = {
        .name         = COMPOUND_STRING("Balls Rapides"),
    ...
    [ITEM_BATTLE_LR_RUN] = {
        .name         = COMPOUND_STRING("Texte Fuite"),
...
static const struct TabDef sTabs[TAB_COUNT] = {
    ...
    [TAB_BATTLE] = { COMPOUND_STRING("Options de Combat"), sTabItems_Battle, ITEM_BATTLE_COUNT },
